		...
		<div class="wrap-login100">
			<form method="POST" class="login100-form validate-form" id="calculate">
                ...
                <div class="wrap-input100 validate-input" data-validate="Masukkan Nomor">
	    			...
	    			<span class="focus-input100" data-placeholder="kriteria berhenti"></span>
				</div>

                <div class="container-login100-form-btn">
		    		<div class="wrap-login100-form-btn">
						<div class="login100-form-bgbtn"></div>
                        <button class="login100-form-btn" name="calculate" data-toggle="modal" data-target="#exampleModalCenter">
                            Calculate
                        </button>
					</div>
				</div>
